...
export const lessonConfig = {
  ...
  learningObjectives: [
    ...
    "Riconoscere all'ascolto il carattere sonoro di Motif Magic: Repeat with Variation",
  ...
  theory: {
    sections: [
      {
        title: "Concetto armonico: Motif Magic: Repeat with Variation",
...
Quando programmi Motif Magic: Repeat with Variation, ascolta tre elementi: stabilità della fondamentale, qualità emotiva dell'intervallo caratteristico e bilanciamento tra le voci. Se una voce domina troppo, il voicing perde chiarezza. In pratica, la teoria qui serve a controllare intenzione e risultato: stessa idea armonica, suono più pulito, scelta più consapevole.`
      },
      {
