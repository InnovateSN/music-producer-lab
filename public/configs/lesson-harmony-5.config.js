...
export const lessonConfig = {
  ...
  progression: {
    difficulty: "beginner",
    prerequisites: ["harmony-4"],
    outcomes: ["Completare gli obiettivi pratici di harmony-5","Consolidare competenze beginner nel modulo harmony"]
  },
  ...
  learningObjectives: [
    "Understand core concepts in harmony 5",
