...
export const lessonConfig = {
  ...
  hero: {
    ...
    titleHighlight: "Widen Your Mix Professionally",
    subtitle: "Use mid-side processing and stereo imaging tools to create width while maintaining mono compatibility. Master professional mastering techniques for commercial release-ready audio."
  },
  
  exercise: {
    title: "Master Stereo Enhancement & Width",
    description: "Use mid-side processing and stereo imaging tools to create width while maintaining mono compatibility. This lesson covers the professional mastering techniques used to prepare tracks for distribution.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Stereo Enhancement & Width',
        content: `Stereo Enhancement & Width is the final step in audio production, preparing your mix for distribution and ensuring it translates across all playback systems.
...
Understanding Stereo Enhancement & Width means knowing when to apply it and when to leave things alone.`
      },
      {
        title: 'Professional Mastering Techniques',
        content: `Apply Stereo Enhancement & Width with professional standards and workflows:
