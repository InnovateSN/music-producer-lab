...
export const lessonConfig = {
  ...
  progression: {
    ...
    prerequisites: ["arrangement-10","arrangement-9"],
    outcomes: ["Completare gli obiettivi pratici di arrangement-11","Consolidare competenze intermediate nel modulo arrangement"]
  },
  depthLevel: 3,
