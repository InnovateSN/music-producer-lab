 ...
 * Lesson: Mixing 9 - Parallel Processing
 */
...
export const lessonConfig = {
  ...
  hero: {
    ...
    titleHighlight: "Blend Wet and Dry Signals",
    subtitle: "Master parallel compression, reverb, and distortion for depth and character while maintaining clarity. Master professional mixing techniques used in commercial productions."
  },
  
  exercise: {
    title: "Master Parallel Processing",
    description: "Master parallel compression, reverb, and distortion for depth and character while maintaining clarity. This lesson covers essential mixing concepts that separate amateur from professional productions.",
    ...
    sections: [
      {
        ...
        content: `Parallel Processing is a fundamental mixing technique that shapes the final sonic character of your productions.
...
Every mixing decision affects the frequency balance. Learn how Parallel Processing interacts with the spectrum.

**Dynamic Considerations:**
Understand how this technique affects the dynamic range and transient response of your audio.

Professional mixers use Parallel Processing to:
...
- Match professional mixing standards`
      },
      {
        ...
        content: `Apply Parallel Processing effectively in your professional workflow:
...
Study reference tracks in your genre. Understand how professional mixers use Parallel Processing to achieve commercial-quality results.
...
- Check your mix on multiple systems`
  ...
  learningObjectives: [
    "Master the fundamental concepts of Parallel Processing",
