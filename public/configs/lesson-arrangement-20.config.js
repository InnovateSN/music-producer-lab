...
export const lessonConfig = {
  ...
  progression: {
    difficulty: "expert",
    prerequisites: ["arrangement-19","arrangement-18"],
    outcomes: ["Completare gli obiettivi pratici di arrangement-20","Consolidare competenze expert nel modulo arrangement"]
  },
  depthLevel: 5,
