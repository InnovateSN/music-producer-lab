...
export const lessonConfig = {
  ...
  progression: {
    difficulty: "advanced",
    prerequisites: ["sound-design-13","sound-design-12"],
    outcomes: ["Completare gli obiettivi pratici di sound-design-14","Consolidare competenze advanced nel modulo sound-design"]
  },
