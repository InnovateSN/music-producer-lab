...
export const lessonConfig = {
  ...
  progression: {
    difficulty: "beginner",
    prerequisites: ["bass-1"],
    outcomes: ["Completare gli obiettivi pratici di bass-2","Consolidare competenze beginner nel modulo bass"]
  },
  ...
  learningObjectives: [
    "Understand core concepts in bass 2",
