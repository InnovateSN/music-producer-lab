...
export const lessonConfig = {
  ...
  learningObjectives: [
    ...
    "Riconoscere all'ascolto il carattere sonoro di Dm7",
  ...
  theory: {
    sections: [
      {
        title: "Concetto armonico: Dorian Mode: The Cool Minor Sound",
...
Quando programmi Dm7, ascolta tre elementi: stabilità della fondamentale, qualità emotiva dell'intervallo caratteristico e bilanciamento tra le voci. Se una voce domina troppo, il voicing perde chiarezza. In pratica, la teoria qui serve a controllare intenzione e risultato: stessa idea armonica, suono più pulito, scelta più consapevole.`
      },
      {
