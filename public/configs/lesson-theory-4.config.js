...
export const lessonConfig = {
  ...
  progression: {
    ...
    outcomes: ["Completare gli obiettivi pratici di theory-4","Consolidare competenze beginner nel modulo theory"]
  },
...
- Film: Lydian, Phrygian
  ...
  practicalActivity: {
    ...
    task: "Crea 2 progressioni modali di 4 accordi (es. D dorico, E frigio) e identifica la nota caratteristica del modo.",
    checklist: [
    ...
    verificationChallenge: "Dato un frammento melodico, identifica il modo più probabile e giustifica con intervalli/degree.",
    completionFeedback: {
