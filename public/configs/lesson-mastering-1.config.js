...
export const lessonConfig = {
  ...
  hero: {
    ...
    titleHighlight: "Understanding the Mastering Process",
    subtitle: "Learn what mastering is, how it differs from mixing, and the complete mastering signal chain. Master professional mastering techniques for commercial release-ready audio."
  },
  
  exercise: {
    title: "Master Mastering Fundamentals",
    description: "Learn what mastering is, how it differs from mixing, and the complete mastering signal chain. This lesson covers the professional mastering techniques used to prepare tracks for distribution.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Mastering Fundamentals',
        content: `Mastering Fundamentals is the final step in audio production, preparing your mix for distribution and ensuring it translates across all playback systems.
...
Understanding Mastering Fundamentals means knowing when to apply it and when to leave things alone.`
      },
      {
        title: 'Professional Mastering Techniques',
        content: `Apply Mastering Fundamentals with professional standards and workflows:
...
Always deliver masters at -14 LUFS integrated for streaming, and provide alternate masters for other formats if needed.`
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "Excellent! You've mastered Mastering Fundamentals. Your masters are release-ready!",
