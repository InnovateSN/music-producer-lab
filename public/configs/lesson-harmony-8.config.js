...
export const lessonConfig = {
  ...
  progression: {
    ...
    prerequisites: ["harmony-7"],
    outcomes: ["Completare gli obiettivi pratici di harmony-8","Consolidare competenze intermediate nel modulo harmony"]
  },
  ...
  learningObjectives: [
    ...
    "Riconoscere all'ascolto il carattere sonoro di Cmaj7",
  ...
  theory: {
    sections: [
      {
        title: "Concetto armonico: Upgrade to 7ths: Maj7 & Min7",
...
Quando programmi Cmaj7, ascolta tre elementi: stabilità della fondamentale, qualità emotiva dell'intervallo caratteristico e bilanciamento tra le voci. Se una voce domina troppo, il voicing perde chiarezza. In pratica, la teoria qui serve a controllare intenzione e risultato: stessa idea armonica, suono più pulito, scelta più consapevole.`
      },
      {
