...
export const lessonConfig = {
  ...
  progression: {
    ...
    prerequisites: ["theory-6"],
    outcomes: ["Completare gli obiettivi pratici di theory-7","Consolidare competenze intermediate nel modulo theory"]
  },
...
- Rock: Power chords (root-5th), triads, occasional 7ths
  ...
  practicalActivity: {
    ...
    task: "Costruisci 5 accordi (triadi e settime) da gradi diversi e indica fondamentale, terza, quinta, settima.",
    checklist: [
    ...
    verificationChallenge: "Analizza 4 voicing e classificali correttamente (maggiore/minore/diminuito/aumentato/dom7).",
    completionFeedback: {
