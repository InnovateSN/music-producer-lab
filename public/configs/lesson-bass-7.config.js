...
export const lessonConfig = {
  ...
  progression: {
    ...
    prerequisites: ["bass-6"],
    outcomes: ["Completare gli obiettivi pratici di bass-7","Consolidare competenze intermediate nel modulo bass"]
  },
  ...
  learningObjectives: [
    "Understand core concepts in bass 7",
