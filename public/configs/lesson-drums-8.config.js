...
export const lessonConfig = {
  ...
  progression: {
    ...
    prerequisites: ["drums-7"],
    outcomes: ["Completare gli obiettivi pratici di drums-8","Consolidare competenze intermediate nel modulo drums"]
  },
