...
export const lessonConfig = {
  ...
  progression: {
    difficulty: "expert",
    prerequisites: ["arrangement-18","arrangement-17"],
    outcomes: ["Completare gli obiettivi pratici di arrangement-19","Consolidare competenze expert nel modulo arrangement"]
  },
  depthLevel: 5,
