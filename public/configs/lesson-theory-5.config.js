...
export const lessonConfig = {
  ...
  progression: {
    ...
    outcomes: ["Completare gli obiettivi pratici di theory-5","Consolidare competenze beginner nel modulo theory"]
  },
...
- Program complex rhythms in MIDI to understand their structure
  ...
  practicalActivity: {
    ...
    task: "Programma 4 pattern ritmici in 4/4 e 6/8 usando minime, semiminime, crome e pause con click attivo.",
    checklist: [
    ...
    verificationChallenge: "Esegui un pattern di 1 battuta con accuratezza ritmica entro la tolleranza prevista e senza anticipi sistematici.",
    completionFeedback: {
