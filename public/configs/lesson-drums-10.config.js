...
export const lessonConfig = {
  ...
  progression: {
    ...
    prerequisites: ["drums-9","drums-8"],
    outcomes: ["Completare gli obiettivi pratici di drums-10","Consolidare competenze intermediate nel modulo drums"]
  },
