...
export const lessonConfig = {
  ...
  progression: {
    difficulty: "advanced",
    prerequisites: ["arrangement-12","arrangement-11"],
    outcomes: ["Completare gli obiettivi pratici di arrangement-13","Consolidare competenze advanced nel modulo arrangement"]
  },
  depthLevel: 4,
