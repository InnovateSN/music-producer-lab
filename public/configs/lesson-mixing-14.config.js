...
export const lessonConfig = {
  ...
  hero: {
    ...
    titleHighlight: "Develop Your Ears",
    subtitle: "Master A/B comparison, frequency analysis, and mixing to professional standards. Master professional mixing techniques used in commercial productions."
  },
  
  exercise: {
    title: "Master Reference Tracks & Critical Listening",
    description: "Master A/B comparison, frequency analysis, and mixing to professional standards. This lesson covers essential mixing concepts that separate amateur from professional productions.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Reference Tracks & Critical Listening',
        content: `Reference Tracks & Critical Listening is a fundamental mixing technique that shapes the final sonic character of your productions.
...
Every mixing decision affects the frequency balance. Learn how Reference Tracks & Critical Listening interacts with the spectrum.

**Dynamic Considerations:**
Understand how this technique affects the dynamic range and transient response of your audio.

Professional mixers use Reference Tracks & Critical Listening to:
...
- Match professional mixing standards`
      },
      {
        ...
        content: `Apply Reference Tracks & Critical Listening effectively in your professional workflow:
...
Study reference tracks in your genre. Understand how professional mixers use Reference Tracks & Critical Listening to achieve commercial-quality results.
...
- Check your mix on multiple systems`
  ...
  learningObjectives: [
    "Master the fundamental concepts of Reference Tracks & Critical Listening",
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "Excellent! You've mastered Reference Tracks & Critical Listening. Your mixes are improving!",
