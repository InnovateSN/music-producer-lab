...
export const lessonConfig = {
  ...
  hero: {
    ...
    title: "Reverb & Space:",
    titleHighlight: "Create Depth and Dimension",
    subtitle: "Use reverb to place elements in 3D space. Master room types, pre-delay, and reverb techniques. Master professional mixing techniques used in commercial productions."
  },
  
  exercise: {
    title: "Master Reverb & Space",
    description: "Use reverb to place elements in 3D space. Master room types, pre-delay, and reverb techniques. This lesson covers essential mixing concepts that separate amateur from professional productions.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Reverb & Space',
        content: `Reverb & Space is a fundamental mixing technique that shapes the final sonic character of your productions.
...
Every mixing decision affects the frequency balance. Learn how Reverb & Space interacts with the spectrum.

**Dynamic Considerations:**
Understand how this technique affects the dynamic range and transient response of your audio.

Professional mixers use Reverb & Space to:
...
- Match professional mixing standards`
      },
      {
        ...
        content: `Apply Reverb & Space effectively in your professional workflow:
...
Study reference tracks in your genre. Understand how professional mixers use Reverb & Space to achieve commercial-quality results.
...
- Check your mix on multiple systems`
  ...
  learningObjectives: [
    "Master the fundamental concepts of Reverb & Space",
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "🎉 Excellent! You've mastered Reverb & Space. Your mixes are improving!",
