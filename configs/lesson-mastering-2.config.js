...
export const lessonConfig = {
  ...
  hero: {
    ...
    titleHighlight: "LUFS, Peak Meters & Spectrum Analysis",
    subtitle: "Master loudness standards (LUFS), peak meters, spectrum analyzers, and phase correlation tools. Master professional mastering techniques for commercial release-ready audio."
  },
  
  exercise: {
    title: "Master Metering & Analysis",
    description: "Master loudness standards (LUFS), peak meters, spectrum analyzers, and phase correlation tools. This lesson covers the professional mastering techniques used to prepare tracks for distribution.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Metering & Analysis',
        content: `Metering & Analysis is the final step in audio production, preparing your mix for distribution and ensuring it translates across all playback systems.
...
Understanding Metering & Analysis means knowing when to apply it and when to leave things alone.`
      },
      {
        title: 'Professional Mastering Techniques',
        content: `Apply Metering & Analysis with professional standards and workflows:
...
Always deliver masters at -14 LUFS integrated for streaming, and provide alternate masters for other formats if needed.`
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "🎉 Excellent! You've mastered Metering & Analysis. Your masters are release-ready!",
