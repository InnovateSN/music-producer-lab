...
export const lessonConfig = {
  ...
  hero: {
    ...
    subtitle: "Apply gentle mastering compression and multiband dynamics to glue the mix together. Master professional mastering techniques for commercial release-ready audio."
  },
  
  exercise: {
    title: "Master Mastering Compression & Dynamics",
    description: "Apply gentle mastering compression and multiband dynamics to glue the mix together. This lesson covers the professional mastering techniques used to prepare tracks for distribution.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Mastering Compression & Dynamics',
        content: `Mastering Compression & Dynamics is the final step in audio production, preparing your mix for distribution and ensuring it translates across all playback systems.
...
Understanding Mastering Compression & Dynamics means knowing when to apply it and when to leave things alone.`
      },
      {
        title: 'Professional Mastering Techniques',
        content: `Apply Mastering Compression & Dynamics with professional standards and workflows:
...
Always deliver masters at -14 LUFS integrated for streaming, and provide alternate masters for other formats if needed.`
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "🎉 Excellent! You've mastered Mastering Compression & Dynamics. Your masters are release-ready!",
