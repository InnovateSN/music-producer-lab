...
export const lessonConfig = {
  ...
  hero: {
    ...
    subtitle: "Learn mastering approaches for EDM, hip-hop, rock, pop, and electronic music. Master professional mastering techniques for commercial release-ready audio."
  },
  
  exercise: {
    title: "Master Genre-Specific Mastering",
    description: "Learn mastering approaches for EDM, hip-hop, rock, pop, and electronic music. This lesson covers the professional mastering techniques used to prepare tracks for distribution.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Genre-Specific Mastering',
        content: `Genre-Specific Mastering is the final step in audio production, preparing your mix for distribution and ensuring it translates across all playback systems.
...
Understanding Genre-Specific Mastering means knowing when to apply it and when to leave things alone.`
      },
      {
        title: 'Professional Mastering Techniques',
        content: `Apply Genre-Specific Mastering with professional standards and workflows:
...
Always deliver masters at -14 LUFS integrated for streaming, and provide alternate masters for other formats if needed.`
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "🎉 Excellent! You've mastered Genre-Specific Mastering. Your masters are release-ready!",
