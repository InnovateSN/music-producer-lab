...
export const lessonConfig = {
  ...
  hero: {
    ...
    subtitle: "Learn mixing approaches for EDM, hip-hop, rock, pop, and electronic music genres. Master professional mixing techniques used in commercial productions."
  },
  
  exercise: {
    title: "Master Genre-Specific Mixing",
    description: "Learn mixing approaches for EDM, hip-hop, rock, pop, and electronic music genres. This lesson covers essential mixing concepts that separate amateur from professional productions.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Genre-Specific Mixing',
        content: `Genre-Specific Mixing is a fundamental mixing technique that shapes the final sonic character of your productions.
...
Every mixing decision affects the frequency balance. Learn how Genre-Specific Mixing interacts with the spectrum.

**Dynamic Considerations:**
Understand how this technique affects the dynamic range and transient response of your audio.

Professional mixers use Genre-Specific Mixing to:
...
- Match professional mixing standards`
      },
      {
        ...
        content: `Apply Genre-Specific Mixing effectively in your professional workflow:
...
Study reference tracks in your genre. Understand how professional mixers use Genre-Specific Mixing to achieve commercial-quality results.
...
- Check your mix on multiple systems`
  ...
  learningObjectives: [
    "Master the fundamental concepts of Genre-Specific Mixing",
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "🎉 Excellent! You've mastered Genre-Specific Mixing. Your mixes are improving!",
