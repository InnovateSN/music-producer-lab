 ...
 * Lesson: Mixing 6 - Panning & Stereo Width
 */
...
export const lessonConfig = {
  ...
  hero: {
    ...
    titleHighlight: "Build an Immersive Mix",
    subtitle: "Create wide, immersive mixes with strategic panning and stereo imaging techniques. Master professional mixing techniques used in commercial productions."
  },
  
  exercise: {
    title: "Master Panning & Stereo Width",
    description: "Create wide, immersive mixes with strategic panning and stereo imaging techniques. This lesson covers essential mixing concepts that separate amateur from professional productions.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Panning & Stereo Width',
        content: `Panning & Stereo Width is a fundamental mixing technique that shapes the final sonic character of your productions.
...
Every mixing decision affects the frequency balance. Learn how Panning & Stereo Width interacts with the spectrum.

**Dynamic Considerations:**
Understand how this technique affects the dynamic range and transient response of your audio.

Professional mixers use Panning & Stereo Width to:
...
- Match professional mixing standards`
      },
      {
        ...
        content: `Apply Panning & Stereo Width effectively in your professional workflow:
...
Study reference tracks in your genre. Understand how professional mixers use Panning & Stereo Width to achieve commercial-quality results.
...
- Check your mix on multiple systems`
  ...
  learningObjectives: [
    "Master the fundamental concepts of Panning & Stereo Width",
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "Excellent! You've mastered Panning & Stereo Width. Your mixes are improving!",
