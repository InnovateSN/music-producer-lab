 ...
 * Lesson: Mixing 7 - Sidechain & Ducking
 */
...
export const lessonConfig = {
  ...
  hero: {
    ...
    titleHighlight: "Create Space with Compression",
    subtitle: "Use sidechain compression to create space, pumping effects, and rhythmic movement in your mixes. Master professional mixing techniques used in commercial productions."
  },
  
  exercise: {
    title: "Master Sidechain & Ducking",
    description: "Use sidechain compression to create space, pumping effects, and rhythmic movement in your mixes. This lesson covers essential mixing concepts that separate amateur from professional productions.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Sidechain & Ducking',
        content: `Sidechain & Ducking is a fundamental mixing technique that shapes the final sonic character of your productions.
...
Every mixing decision affects the frequency balance. Learn how Sidechain & Ducking interacts with the spectrum.

**Dynamic Considerations:**
Understand how this technique affects the dynamic range and transient response of your audio.

Professional mixers use Sidechain & Ducking to:
...
- Match professional mixing standards`
      },
      {
        ...
        content: `Apply Sidechain & Ducking effectively in your professional workflow:
...
Study reference tracks in your genre. Understand how professional mixers use Sidechain & Ducking to achieve commercial-quality results.
...
- Check your mix on multiple systems`
  ...
  learningObjectives: [
    "Master the fundamental concepts of Sidechain & Ducking",
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "🎉 Excellent! You've mastered Sidechain & Ducking. Your mixes are improving!",
