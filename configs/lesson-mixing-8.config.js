 ...
 * Lesson: Mixing 8 - Automation in Mixing
 */
...
export const lessonConfig = {
  ...
  hero: {
    ...
    titleHighlight: "Bring Your Mix to Life",
    subtitle: "Use volume, pan, and effect automation throughout the arrangement to create movement and interest. Master professional mixing techniques used in commercial productions."
  },
  
  exercise: {
    title: "Master Automation in Mixing",
    description: "Use volume, pan, and effect automation throughout the arrangement to create movement and interest. This lesson covers essential mixing concepts that separate amateur from professional productions.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Automation in Mixing',
        content: `Automation in Mixing is a fundamental mixing technique that shapes the final sonic character of your productions.
...
Every mixing decision affects the frequency balance. Learn how Automation in Mixing interacts with the spectrum.

**Dynamic Considerations:**
Understand how this technique affects the dynamic range and transient response of your audio.

Professional mixers use Automation in Mixing to:
...
- Match professional mixing standards`
      },
      {
        ...
        content: `Apply Automation in Mixing effectively in your professional workflow:
...
Study reference tracks in your genre. Understand how professional mixers use Automation in Mixing to achieve commercial-quality results.
...
- Check your mix on multiple systems`
  ...
  learningObjectives: [
    "Master the fundamental concepts of Automation in Mixing",
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "🎉 Excellent! You've mastered Automation in Mixing. Your mixes are improving!",
