...
export const lessonConfig = {
  ...
  hero: {
    ...
    subtitle: "Use linear phase and mid-side EQ to shape the final tonal balance without phase issues. Master professional mastering techniques for commercial release-ready audio."
  },
  
  exercise: {
    title: "Master Mastering EQ",
    description: "Use linear phase and mid-side EQ to shape the final tonal balance without phase issues. This lesson covers the professional mastering techniques used to prepare tracks for distribution.",
  ...
  theory: {
    sections: [
      {
        title: 'Understanding Mastering EQ',
        content: `Mastering EQ is the final step in audio production, preparing your mix for distribution and ensuring it translates across all playback systems.
...
Understanding Mastering EQ means knowing when to apply it and when to leave things alone.`
      },
      {
        title: 'Professional Mastering Techniques',
        content: `Apply Mastering EQ with professional standards and workflows:
...
Always deliver masters at -14 LUFS integrated for streaming, and provide alternate masters for other formats if needed.`
  ...
  messages: applyMessagePreset("default", {
    ...
    success: "Excellent! You've mastered Mastering EQ. Your masters are release-ready!",
